...
from src.helpers.file_io import read_image, write_image
from src.datasets.kitti_utils import get_calib_from_file, get_objects_from_label, convertRot2Alpha
from src.helpers.util import *
...
def plot_boxes_on_image_and_in_bev(predictions_img, plot_color, box_class_list= ["car", "cyclist", "pedestrian"], use_classwise_color= False, show_3d= True, show_bev= True, show_2d_box= False, thickness= 4):
    ...
    class_color_map = {'car': (255,51,153),
                       ...
                       'building': (47, 79, 79), # # Darkslategrey
                       }
...
if dataset == "kitti":
    ...
    gt_folder = "data/kitti_360/validation"
...
# Output
# ==================================================================================================
img_save_folder   = "images/qualitative/" + folder.split("/")[1] + "_" + dataset #"waymo_with_gt_segment-14739149465358076158_4740_000_4760_000_with_camera_labels_new"
if video_demo_flag:
...
# elif dataset == "kitti_360":
#     file_index = [8194, 12854, 27591, 38056, 34229, 22907, 18387, 3258, 22584, 46332, 43093]
#     # [6249, 32153, 15437, 33183, 19967, 33788, 5436, 28120, 31620, 33426]
#     # [37979, 32501, 46596, 1955, 11278, 14888, 3808, 39333, 2449, 15919]
# file_index = np.array(file_index)
# num_files_to_plot = file_index.shape[0]
